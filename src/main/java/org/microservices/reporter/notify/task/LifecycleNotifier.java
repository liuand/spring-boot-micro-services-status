...
@Slf4j
@Configuration
@ConditionalOnProperty(prefix = "microservices.reporter.lifecycle", name = "enabled", matchIfMissing = true)
public class LifecycleNotifier implements SmartLifecycle {
    ...
    @Data
    @Configuration
    @ConfigurationProperties(prefix = "microservices.reporter.lifecycle")
