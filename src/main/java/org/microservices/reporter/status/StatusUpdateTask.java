...
import org.microservices.reporter.registry.MapStore;
...
public class StatusUpdateTask {
    ...
    @Scheduled(initialDelayString = "${microservices.reporter.initialDelay:20000}", fixedRateString = "${microservices.reporter.rate:10000}")
